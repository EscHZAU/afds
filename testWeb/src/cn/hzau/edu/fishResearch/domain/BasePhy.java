...
/**
 * BasePhy entity. @author MyEclipse Persistence Tools
 */

public class BasePhy implements java.io.Serializable {
	...
	/** minimal constructor */
	public BasePhy(String species) {
		this.species = species;
	}

	/** full constructor */
	public BasePhy(String species, String latinSpecies, String genus,

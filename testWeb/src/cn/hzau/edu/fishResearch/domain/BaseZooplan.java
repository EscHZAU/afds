...
/**
 * BaseZooplan entity. @author MyEclipse Persistence Tools
 */

public class BaseZooplan implements java.io.Serializable {
	...
	/** minimal constructor */
	public BaseZooplan(String species) {
		this.species = species;
	}

	/** full constructor */
	public BaseZooplan(String species, String latinSpecies, String genus,
			...
			String latinSubphylum, String attribute, Blob picture,
